#ifndef CAFFE_RDETECTION_OUTPUT_LAYER_HPP_
#define CAFFE_RDETECTION_OUTPUT_LAYER_HPP_
...
class RDetectionOutputLayer : public Layer<Dtype>
{
public:
	explicit RDetectionOutputLayer(const LayerParameter& param)
		: Layer<Dtype>(param) {}
...
protected:
	...
	*/
	...
	string save_file_;
	Blob<Dtype> rbox_preds_;
	Blob<Dtype> rbox_permute_;
...
#endif  // CAFFE_RDETECTION_OUTPUT_LAYER_HPP_
